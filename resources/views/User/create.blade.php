            ...
            <div class="offset-md-1 col-md-5 col-lg-5 card shadow-lg p-3 mb-5 bg-white rounded">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" pattern=".{3,}" class="form-control" required name="user_name" placeholder="Minimum 3 Character">
                    </div>
                    <div class="form-group">
                        <label for="" class="">Full Name</label>
                        <input type="text" pattern=".{3,}" class="form-control" required name="name" placeholder="Minimum 3 Character">
                    </div>
                    <div class="form-group">
                        <label for="" class="">Email Address</label>
                        <input type="email" class="form-control" required name="email" placeholder="Must be a valid email-address.">
                    </div>
                    <div class="form-group">
                        <label for="" class="">Password</label>
                        <input type="password"  pattern=".{6,}"class="form-control" required name="password" placeholder="Minimum 6 Character">
                    </div>
                    </div>
             ...
             <div class="col-md-5 col-lg-5 card cardgap shadow-lg p-3 mb-5 bg-white rounded">
                ...
                <div class="card-body">
                    <ol>
                        <li>
                            <strong>User Name</strong> must be between 3 to 10 characters long. Only alphabets, numbers, dots, hyphens and underscores are allowed.
                        </li>
                        <li>
