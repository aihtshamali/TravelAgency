        ...
        <div class="row">
                ...
                <div class="card">
                        ...
                        <div class="input-group">
                            <select name="LeadId" class="form-control">
                                ...
                                @foreach ($leads as $lead)
                                    <option <?php if($lead->LeadID == $sale->LeadIDRef) echo "selected='selected'"; ?> value="{{$lead->LeadID}}">[Lead{{$lead->LeadID}}] </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="SaleBy" class="form-control">
                                @foreach ($users as $user)
                                    <option <?php if($user->user_name == $sale->SaleBy) echo "selected='selected'"; ?> value="{{$user->id}}">{{$user->user_name}} [{{$user->name}}] </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                    <div class="card">
                        ...
                        <input type="number" onblur="ValidateAmount()" required id="amount" name="amount" class="form-control" value="{{$sale->Amount}}" autocomplete="off" >
                        </div>
                        <div class="form-group">
                            <label for="NetCost">Net Cost</label>
                            <input type="number" onblur="ValidateAmount()" required name="cost" id="cost" value="{{$sale->NetCost}}" class="form-control" autocomplete="off" >
                        </div>
                        <div class="form-group">
                            <label for="NetCost">Profit Amount</label>
                            <input type="number" readonly="readonly" value="0" id="profit" name="profit" value="{{$sale->ProfitAmount}}" required name="ProfitAmount" class="form-control" autocomplete="off" >
                        </div>
                ...
                <div class="card">
                    ...
                    <h3>Product Sold </h3>
                     ...
                     <div class="card-body">
                       ...
                       <input required type="date" name="IssueDate"  value="{{$sale->IssueDate}}" class="form-control" autocomplete="off" >
                       </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" name="ProductPax"  value="{{$sale->ProductPax}}"  class="form-control" autocomplete="off" >
                       </div>
                       <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="ProductDetail"  value="{{$sale->ProductDetail}}" id="subject" class="form-control" placeholder="From ---- TO ---">
                            </div>
                    </div>
                    <div class="form-group">
                        <label for="AccountigText">Accounting Remarks</label>
                    <input type="text" placeholder="Issued from (Self or Vendor Name)" value="{{$sale->AccountingText}}" name="AccountigText" class="form-control" autocomplete="off" >
                    </div>
                    </div>   
                </div>
